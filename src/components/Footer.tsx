        ...
        return (
          ...
          >
            <div className='space-y-5'>
                <h2 className='font-bold text-3xl'>Bob</h2>
            ...
            <div className='border-t py-5 border-[var(--text-element-small)] text-sm text-[var(--text-element-small-black)]'>Copyright <span className='italic font-bold'>Bob</span> All Rights Reserved</div>
          </motion.div>  
