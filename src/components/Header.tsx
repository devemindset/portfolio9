...
const Header: FC = () => {
  ...
  return (
    <header className='fixed w-full h-10 sm:h-20 2xl:h-30 bg-[var flex justify-between items-center px-5 sm:px-10 md:px-20 text-[var(--text-element-small-black)] z-40 top-0 md:h-14 '>
